SOUNDBOARD 1.3.1 FOR WINDOWS X64
================================
...
Installer:
Run Soundboard-Setup-v1.3.1-win-x64.exe. The per-user installer's Select
...
Soundboard 1.3.1 does not include automatic updates or background update
checks.
